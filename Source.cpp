...
int main() {
    ...
    // Демонстрація для трикутника за сторонами
    TriangleBySides triangle1(5, 6, 7);
    ...
    // Демонстрація для трикутника за вершинами
    TriangleByVertices triangle2(0, 0, 4, 0, 0, 3);
